...
public class PeerConnectionClient {
    ...
    public static class PeerConnectionParameters {
        ...
        public String toString() {
            ...
            sb.append("videoCallEnable: ").append(videoCallEnabled).append("\\n");
            sb.append("maxVideoBitrate: ").append(maxVideoBitrate).append("\\n");
    ...
    private void createPeerConnectionFactoryInternal(Context context) {
        ...
        LogCat.debug(ICE_TAG, "--createPeerConnectionFactoryInternal parameter --" + peerConnectionParameters.toString());
...
//        PeerConnectionFactory.initializeFieldTrials(FIELD_TRIAL_AUTOMATIC_RESIZE);
    ...
    private void createMediaConstraintsInternal() {
        ...
        LogCat.debug(ICE_TAG,"--createMediaConstraintsInternal");
...
//        }
    ...
    private void createPeerConnectionInternal(EglBase.Context renderEGLContext) {
        ...
        if (videoCallEnabled) {
            ...
            videoCapturer = VideoCapturerAndroid.create(cameraDeviceName, null, peerConnectionParameters.captureToTexture);
    ...
    private void drainCandidates() {
        if (queuedRemoteCandidates != null) {
            ...
            for (IceCandidate candidate : queuedRemoteCandidates) {
                LogCat.debug(ICE_TAG , "add iceCandidate :" + candidate.sdp);
                peerConnection.addIceCandidate(candidate);
            }
            queuedRemoteCandidates = null;
        }
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        public void onIceCandidate(final IceCandidate candidate) {
            executor.execute(new Runnable() {
                @Override
                public void run() {
                    LogCat.debug(ICE_TAG, "local ice : " + candidate.sdp);
        ...
        public void onIceCandidatesRemoved(IceCandidate[] candidates) {
            ...
            LogCat.debug(ICE_TAG, "onIceCandidatesRemoved: " + candidates[0]);
        ...
        public void onSignalingChange(
            ...
            LogCat.debug(ICE_TAG, "SignalingState: " + newState);
        }
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    if (peerConnection != null && !isError) {
                        ...
                        LogCat.debug(ICE_TAG, "Set local SDP : " + sdp.description);
